var nama = 'Mikael' || 'Nina' || 'Danu' || 'Zero';
var peran = 'Ksatria' || 'Tabib' || 'Penyihir';

console.log('//Output untuk Input 1')
if (nama = 'Mikael') {
  {
  ...
  console.log('//Output untuk Input 2')
  if (nama = 'Nina') {
  ...
  console.log('//Output untuk Input 3')
  if (nama = 'Danu') {
  ...
  console.log('//Output untuk Input 4')
  if (nama = 'Zero') {
